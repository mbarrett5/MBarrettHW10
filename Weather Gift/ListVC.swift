...
class ListVC: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "ToPageVC" {
            ...
            //Identify the table cell (row) that the user tapped. This is passed back to PageVC as currentPage so PageVC knows which page to create and display
...
extension ListVC: UITableViewDataSource, UITableViewDelegate {
    ...
    //MARK: Table view code to freeze the first cell. No deleting or moving
